    ...
    public static void buenos() {
        ...
        if (respuesta.equals("buenos") == true)
        {
            ...
            System.out.println("Qué detalle, tu mujer murió hace 4 años \n"
                    ...
                    + "porque cuando jugamos a los tacos de madera y le pego \n"
                    + "con uno en la cabeza, de repente se pone a llorar.\n");
            Scanner entra1 = new Scanner(System.in);
            System.out.println("Si Quieres más chistes BUENOS digite **si** : ");
